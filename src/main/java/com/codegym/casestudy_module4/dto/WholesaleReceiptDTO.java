...
@AllArgsConstructor
@NoArgsConstructor
public class WholesaleReceiptDTO {
        private Long id;
...
//        @NotEmpty(message = "Chuẩn đoán không được để trống")
        ...
        public WholesaleReceiptDTO(String code, Customer customer, Employee employee, String symptoms, String doctor, String doctor_address, String diagnose, String note, LocalDateTime createdAt, List<MedicineDTO> items) {
            this.code = code;
        ...
        public WholesaleReceiptDTO(String code, Customer customer, Employee employee, String note, LocalDateTime createdAt, List<MedicineDTO> items) {
            this.code = code;
            this.customer = customer;
            this.employee = employee;
            this.note = note;
